...
public class Partida {
    ...
    public String toString() {
        if(jog1Pontos>jog2Pontos)
            return "\n----- "+id+"ª Partida -----\nO jogador "+jog1Nome+" (você) venceu a partida com "+jog1Pontos+" pontos!\nO jogador "+jog2Nome+" (computador) perdeu a partida com "+jog2Pontos+" pontos.";
        else if(jog1Pontos<jog2Pontos)
            return "\n----- "+id+"ª Partida -----\nO jogador "+jog2Nome+" (computador) venceu a partida com "+jog2Pontos+" pontos!\nO jogador "+jog1Nome+" (você) perdeu a partida com "+jog1Pontos+" pontos.";
        else
            return "\n----- "+id+"ª Partida -----\nOs jogadores "+jog1Nome+" (você) e "+jog2Nome+" (computador) empataram na partida com "+jog1Pontos+" pontos.";
    }
    public int getId() {
        return id;
    }
