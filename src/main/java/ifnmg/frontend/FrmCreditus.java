...
public class FrmCreditus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHoll = new javax.swing.JLabel();
        ...
        lblHoll.setText("¡Bienvenido al Salón de las Leyendas!");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new FrmCreditus().setVisible(true));
    }
    ...
    private javax.swing.JLabel lblHoll;
