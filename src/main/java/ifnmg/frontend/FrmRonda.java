...
public class FrmRonda extends javax.swing.JFrame {
    ...
    public FrmRonda(int quantVitorias, int idPartida, int pts) {
        rodadaList.clear();
        FrmRonda.idPartida=idPartida;
        FrmRonda.quantVitorias=quantVitorias;
        FrmRonda.pts=pts;
        initComponents();
        ...
        if(comboBox.getSelectedItem()=="Aleatorio"){
            ...
            JOptionPane.showMessageDialog(null, "¡Se sortearon " + quantRodadas + " rondas para el partido!");
        }
        else{
        ...
        lblJog1Nome.setText("Jugador 1 (tú): "+jog1.getNome());
    ...
    private void initComponents() {
        ...
        lblJog1Nome.setText("Jugador 1 (tú): ");
        ...
        lblPista.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PistaConfronto.png"))); // NOI18N
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        if(resposta == JOptionPane.YES_OPTION){
            new FrmJugadores(FrmRonda.quantVitorias, FrmRonda.idPartida-1, FrmRonda.pts, null, null).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRonda(FrmRonda.quantVitorias, FrmRonda.idPartida, FrmRonda.pts).setVisible(true);
            }
        });
    }
    ...
    private static void somVitoria(Personagem jog){
        try{
            ...
            if("Mario".equals(jog.getNome()))
                ...
                audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/samuel-esp/melhor.wav"));
            else
                audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/didi/ins-esp.wav"));
