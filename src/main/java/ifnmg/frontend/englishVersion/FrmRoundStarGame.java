/*
Frame da tela de execução de rodada do Jogo das Estrelas (inglês)
...
public class FrmRoundStarGame extends javax.swing.JFrame {
    ...
    public FrmRoundStarGame(int vitoriasLeo, int vitoriasCaio, int idPartida) {
        rodadaList.clear();
        FrmRoundStarGame.idPartida=idPartida;
        FrmRoundStarGame.vitoriasLeo=vitoriasLeo;
        FrmRoundStarGame.vitoriasCaio=vitoriasCaio;
        initComponents();
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        ...
        if(numRodada<=quantRodadas){
            ...
            new FrmEndStarGame(FrmRoundStarGame.vitoriasLeo, FrmRoundStarGame.vitoriasCaio, FrmRoundStarGame.idPartida, FrmRoundStarGame.rodadaList).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRoundStarGame(FrmRoundStarGame.vitoriasLeo, FrmRoundStarGame.vitoriasCaio, FrmRoundStarGame.idPartida).setVisible(true);
            }
        });
    }
