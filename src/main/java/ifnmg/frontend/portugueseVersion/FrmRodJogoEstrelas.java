/*
Frame da tela de execução de rodada do Jogo das Estrelas (português)
...
public class FrmRodJogoEstrelas extends javax.swing.JFrame {
    ...
    public FrmRodJogoEstrelas(int vitoriasLeo, int vitoriasCaio, int idPartida) {
        rodadaList.clear();
        FrmRodJogoEstrelas.idPartida=idPartida;
        FrmRodJogoEstrelas.vitoriasLeo=vitoriasLeo;
        FrmRodJogoEstrelas.vitoriasCaio=vitoriasCaio;
        initComponents();
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        ...
        if(numRodada<=quantRodadas){
            ...
            new FrmFimJogoEstrelas(FrmRodJogoEstrelas.vitoriasLeo, FrmRodJogoEstrelas.vitoriasCaio, FrmRodJogoEstrelas.idPartida, FrmRodJogoEstrelas.rodadaList).setVisible(true);
            this.dispose();
        }
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        if(resposta == JOptionPane.YES_OPTION){
            jogStar.close();
            new FrmJogsJogoEstrelas(FrmRodJogoEstrelas.vitoriasLeo, FrmRodJogoEstrelas.vitoriasCaio, FrmRodJogoEstrelas.idPartida-1).setVisible(true);
            this.dispose();
        }
    ...
    private void btnDado4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDado4ActionPerformed
        ...
        if(dado3%2==0){
            ...
            JOptionPane.showMessageDialog(null,jog2.getNome()+" jogou o dado novamente e obteve "+dado3+". Como "+dado3+" é ímpar, "+jog1.getNome()+" não somou pontos.");
        btnProximo.setVisible(true);
        btnProximo.setEnabled(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRodJogoEstrelas(FrmRodJogoEstrelas.vitoriasLeo, FrmRodJogoEstrelas.vitoriasCaio, FrmRodJogoEstrelas.idPartida).setVisible(true);
            }
        });
    }
