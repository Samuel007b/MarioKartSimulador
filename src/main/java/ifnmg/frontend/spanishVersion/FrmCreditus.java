/*
Frame da tela especial de créditos (espanhol)
...
public class FrmCreditus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHall.setText("¡Bienvenido al Salón de las Leyendas!");
    ...
    private void lblSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lblSairActionPerformed
        int resposta = JOptionPane.showConfirmDialog(null, "¿Quieres terminar el juego?", "Cerrar el Juego", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            JOptionPane.showMessageDialog(null, "Gracias por jugar Mario Kart Simulator, ¡vuelve cuando quieras!");
            this.dispose();
            JOptionPane.showMessageDialog(null, null, "¡La creatividad no tiene límites!", JOptionPane.INFORMATION_MESSAGE, mcqueen);
        }
    ...
    private void btnJogoEstrelasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJogoEstrelasActionPerformed
        ...
        if(resposta == JOptionPane.YES_OPTION){
            ...
            JOptionPane.showMessageDialog(null, "¡Bienvenido al Juego de las Estrellas! Es una competencia similar al juego original, pero con personajes especiales y una selección aleatoria de atributos.");
            new FrmJugsJuegoEstrellas(0, 0, 0).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        new FrmCreditus(jogoEstrelas).setVisible(true);
    }
