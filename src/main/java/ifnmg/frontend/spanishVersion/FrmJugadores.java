/*
Frame da tela de seleção de personagens (espanhol)
...
public class FrmJugadores extends javax.swing.JFrame {
    ...
    public FrmJugadores(int quantVitorias, int idPartida, int pts, Personagem jog1, Personagem jog2) {
        FrmJugadores.idPartida=idPartida+1;
        FrmJugadores.quantVitorias=quantVitorias;
        FrmJugadores.pts=pts;
        try{
            personagemList = csvToList("data/tabela-personagens.csv");
            initComponents();
            if(FrmJugadores.pts>=3){
                btnP8.setIcon(samuel);
                if(FrmJugadores.pts>=4)
                    btnP9.setIcon(didi);
            }
            ...
            else if(FrmJugadores.pts==4 && vencedor(jog1, jog2)==jog1){
                JOptionPane.showMessageDialog(null, "¡¡¡Has desbloqueado el personaje DIDI SHOW!!!");
                try{
                    AudioInputStream audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/didi/mer-esp.wav"));
    ...
    private void initComponents() {
        ...
        btnSelectP1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Mario-esp.gif"))); // NOI18N
        ...
        btnSelectP2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Bowser-esp.gif"))); // NOI18N
        ...
        btnSelectP3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Toad-esp.gif"))); // NOI18N
        ...
        btnSelectP4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Luigi-esp.gif"))); // NOI18N
        ...
        btnSelectP5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Peach-esp.gif"))); // NOI18N
        ...
        btnSelectP6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Yoshi-esp.gif"))); // NOI18N
        ...
        btnSelectP7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Dk-esp.gif"))); // NOI18N
        ...
        btnSelectP8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Samuel-esp.gif"))); // NOI18N
        ...
        btnSelectP9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/buttons/Didi-esp.gif"))); // NOI18N
        ...
        lblPlayer.setText("Jugador 1 (tú):");
        ...
        lblVelocidade.setText("Velocidad:");
        ...
        lblManobrabilidade.setText("Maniobrabilidad:");
    ...
    private void btnSelectP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP1ActionPerformed
        btnP1ActionPerformed(evt);
        int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(0).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            ...
            JOptionPane.showMessageDialog(null,"Elige de nuevo.");
        }
    ...
    private void btnSelectP2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP2ActionPerformed
        btnP2ActionPerformed(evt);
        int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(1).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            btnP2ActionPerformed(evt);
    ...
    private void btnSelectP3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP3ActionPerformed
        btnP3ActionPerformed(evt);
        int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(2).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            btnP3ActionPerformed(evt);
    ...
    private void btnSelectP4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP4ActionPerformed
        btnP4ActionPerformed(evt);
        int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(3).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            btnP4ActionPerformed(evt);
    ...
    private void btnSelectP5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP5ActionPerformed
        btnP5ActionPerformed(evt);
        int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(4).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            btnP5ActionPerformed(evt);
    ...
    private void btnSelectP6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP6ActionPerformed
        btnP6ActionPerformed(evt);
        int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(5).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            btnP6ActionPerformed(evt);
    ...
    private void btnSelectP7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP7ActionPerformed
        btnP7ActionPerformed(evt);
        int resposta = JOptionPane.showConfirmDialog(null, "Você quer mesmo jogar com "+personagemList.get(6).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if(resposta == JOptionPane.YES_OPTION){
            btnP7ActionPerformed(evt);
    ...
    private void btnSelectP8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP8ActionPerformed
        btnP8ActionPerformed(evt);
        if(FrmJugadores.pts>=3){
            int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(7).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if(resposta == JOptionPane.YES_OPTION){
                try{
                    AudioInputStream audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/samuel-esp/escolha.wav"));
            ...
            JOptionPane.showMessageDialog(null,"Personaje bloqueado, ¡gana tres partidos para desbloquearlo!");
    ...
    private void btnSelectP9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectP9ActionPerformed
        btnP9ActionPerformed(evt);
        if(FrmJugadores.pts>=4){
            int resposta = JOptionPane.showConfirmDialog(null, "¿De verdad quieres jugar con "+personagemList.get(8).getNome()+"?", "Confirmar Jugador", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if(resposta == JOptionPane.YES_OPTION){
                try{
                    AudioInputStream audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/didi/mer-esp.wav"));
        ...
        else if(FrmJugadores.pts==3){
            JOptionPane.showMessageDialog(null,"Personaje bloqueado, ¡gana una partida con Samuel para desbloquearlo!");
        }
        else
            JOptionPane.showMessageDialog(null,"¡Personaje bloqueado!");
    ...
    private void btnP8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnP8ActionPerformed
        ...
        if(FrmJugadores.pts>=3){
            try{
                AudioInputStream audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/samuel-esp/melhor.wav"));
    ...
    private void btnP9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnP9ActionPerformed
        ...
        if(FrmJugadores.pts>=4){
            try{
                AudioInputStream audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/didi/ins-esp.wav"));
                Clip didiins = AudioSystem.getClip();
                didiins.open(audio);
                didiins.start();
            }
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        new FrmRonda(FrmJugadores.quantVitorias, FrmJugadores.idPartida, FrmJugadores.pts).setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmJugadores(FrmJugadores.quantVitorias, FrmJugadores.idPartida, FrmJugadores.pts, jog1, jog2).setVisible(true);
            }
        });
    }
    private static void somPlayer2(Personagem jog2){
        try{
            ...
            if("Mario".equals(jog2.getNome()))
                ...
                audio = AudioSystem.getAudioInputStream(new File("src/main/resources/audios/samuel-esp/estouaqui.wav"));
            else
    ...
    private static void visualizarPlayer(javax.swing.JLabel lblPlayer, javax.swing.JLabel lblImagem, javax.swing.JLabel lblNome, javax.swing.JLabel lblVelocidade, javax.swing.JLabel lblManobrabilidade, javax.swing.JLabel lblPoder, int id){
        ...
        lblVelocidade.setText("Velocidad: "+personagemList.get(id).getVelocidade());
        lblManobrabilidade.setText("Maniobrabilidad: "+personagemList.get(id).getManobrabilidade());
